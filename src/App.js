...
export const App=()=>{
  ...
  return(
   ...
   <form onSubmit={my}>
    ...
    <label>email:</label>
    <input className="form-control" type="email" value={email} onChange={(x)=>{setEmail(x.target.value)}}></input>
   <label>password:</label>
   <input className="form-control" type="password" value={password} onChange={(x)=>{setPassword(x.target.value)}}></input>
